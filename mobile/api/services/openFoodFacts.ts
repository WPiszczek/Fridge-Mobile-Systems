...
export interface Product {
  ...
  image_url: string;
  images: Record<number, ProductImageNumbered> &
    Record<ImageType, ProductImageNamed>; // TODO add langages to ImageType
  informers: string[];
  ...
  rev: number;
  scans_n: number;
  selected_images: Partial<
    Record<ImageType, Record<ImageSize, Record<string, string>>>
  >;
